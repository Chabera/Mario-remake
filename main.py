@namespace
class SpriteKind:
    mince_t = SpriteKind.create()

def on_on_overlap(sprite, otherSprite):
    otherSprite.destroy()
    info.change_score_by(1)
sprites.on_overlap(SpriteKind.player, SpriteKind.mince_t, on_on_overlap)
...
scene.set_background_image(img("""
    ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        
...
""")):
    pokemon = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    tiles.place_on_tile(pokemon, value)
    tiles.set_tile_at(value, assets.tile("""
        transparency16
    """))
pokemon.ay = 130
controller.move_sprite(pokemon, 100, 0)
scene.camera_follow_sprite(pokemon)
